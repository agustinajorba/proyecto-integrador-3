            ...
            <div className="containerCard">
                ...
                <div className='botonesHome'>
                    ...
                    </Link>
                    {
                        this.state.favorito ?
                            <button
                                className='botonFavoritosCard'
                                onClick={() => {
                                    this.sacarFavoritos(movies.id);
                                    if (this.props.borrarDeCarrito) {
                                        this.props.borrarDeCarrito(movies.id);
                                    }
                                }}
                            >
                                Sacar de Favoritos
                            ...
                            <button
                                className='botonFavoritosCard'
                                onClick={() => this.agregarFavoritos(movies.id)}
                            >
                                Agregar a Favoritos
                            </button>
                    }
